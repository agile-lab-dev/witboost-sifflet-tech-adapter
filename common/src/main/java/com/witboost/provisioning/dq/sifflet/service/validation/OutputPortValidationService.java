...
public class OutputPortValidationService implements ComponentValidationService {
    ...
    public Either<FailedOperation, Void> validate(
        ...
        // TODO Remember to remove the super call and implement the validation for the output port.
        //  If your tech adapter doesn't support output ports, remove this class and its configuration
